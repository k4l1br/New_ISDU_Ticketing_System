...
class LoginController extends Controller
{
    ...
    */
    ...
    public function login(Request $request)
    {
        ...
        \Log::info('Authentication field determined', ['field' => $field, 'value' => $login]);

        if (Auth::attempt([$field => $login, 'password' => $password], $request->filled('remember'))) {
            \Log::info('Authentication successful', ['field' => $field, 'value' => $login]);
        ...
        \Log::warning('Authentication failed', ['field' => $field, 'value' => $login]);
