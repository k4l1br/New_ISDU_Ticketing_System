                ...
                <form action="{{ route('ticket.update', $ticket->id) }}" method="POST">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <small class="form-text text-muted">
                                        <i class="fas fa-info-circle"></i> Provide a clear and detailed description of the task or request.
                                    </small>
                                </div>
                            </div>
                        </div>
                        ...
                        @else
                            ...
                            <!-- Task Description Section for Admin (Read-only) -->
                            <div class="row mt-3">
                                <div class="col-12">
                                    <div class="alert alert-light">
                                        <h6 class="text-warning mb-2">
                                            <i class="fas fa-clipboard-list"></i> Task Description
                                        </h6>
                                        @if($ticket->description)
                                            <p class="mb-0">{{ $ticket->description }}</p>
                                        @else
                                            <p class="text-muted mb-0 font-italic">No description provided.</p>
                                        @endif
                                    </div>
                                </div>
                            </div>
                            
                            <!-- Current Status Display for Admin (Read-only) -->
                            <div class="row mt-3">
                                <div class="col-12">
                                    <div class="alert alert-info">
                                        ...
                                        <span class="badge badge-lg badge-{{ $ticket->status === 'complete' ? 'success' : ($ticket->status === 'in progress' ? 'primary' : 'warning') }}">
                                            {{ ucfirst($ticket->status) }}
                                        </span>
                                        <p class="mb-0 mt-2 text-muted">
                                            <i class="fas fa-info-circle"></i> 
                                            Only super administrators can update ticket status
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                @else
                                    <div class="alert alert-warning mb-3">
                                        ...
                                        <strong>View Only:</strong> You can view this ticket but cannot make changes. Contact a super administrator for updates.
                                    </div>
                                @endif
